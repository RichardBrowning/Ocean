...
namespace ocean
{
    ...
    {
        unmap();
        vkDestroyBuffer(oceanDevice.device(), buffer, nullptr);
        vkFreeMemory(oceanDevice.device(), memory, nullptr);
    }
    ...
    VkResult OceanBuffer::map(VkDeviceSize size, VkDeviceSize offset)
    {
        ...
        return vkMapMemory(oceanDevice.device(), memory, offset, size, 0, &mapped);
    }
    ...
    void OceanBuffer::unmap()
    {
        if (mapped)
        {
            vkUnmapMemory(oceanDevice.device(), memory);
            mapped = nullptr;
        }
    }
    ...
    VkResult OceanBuffer::flush(VkDeviceSize size, VkDeviceSize offset)
    {
        ...
        return vkFlushMappedMemoryRanges(oceanDevice.device(), 1, &mappedRange);
    }
    ...
    VkResult OceanBuffer::invalidate(VkDeviceSize size, VkDeviceSize offset)
    {
        ...
        mappedRange.offset = offset;
        mappedRange.size = size;
        return vkInvalidateMappedMemoryRanges(oceanDevice.device(), 1, &mappedRange);
    }
