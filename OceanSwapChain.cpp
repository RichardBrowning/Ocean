...
namespace ocean {
	...
	OceanSwapChain::OceanSwapChain(OceanDevice &deviceRef, VkExtent2D extent) : device{deviceRef}, windowExtent{extent} {
		init();
	}

	OceanSwapChain::OceanSwapChain(OceanDevice &deviceRef, VkExtent2D extent, std::shared_ptr<OceanSwapChain> oldSwapChain) : device{deviceRef}, windowExtent{extent}, oldSwapChain{oldSwapChain} {
		init();
	...
	VkResult OceanSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex) {
	...
	VkSurfaceFormatKHR OceanSwapChain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats) {
	...
	VkPresentModeKHR OceanSwapChain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes) {
